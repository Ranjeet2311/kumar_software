        ...
        <div className="row work">
          <div className="col-12 col-lg-6">
            ...
            <p className="mt-4">
              ...
              objectives. Through interactive sessions, we discuss your vision
              for the project. The target audience and user expectations.
              Specific features, functionality, and scope of work. During this
              phase, we gather all the critical information and establish a
              clear roadmap, ensuring we’re aligned on your goals from the very
              beginning. Our goal is to collaborate with you as a partner to
      ...
      >
        <div className="row work">
          <div className="col-12 col-lg-6 order-lg-2 order-1">
            ...
            <p className="mt-4">
              Once we’ve analyzed your requirements, our expert team gets to
              work. We provide insights into the latest technologies and
              frameworks that fit your needs. Offer creative solutions to
              enhance user experience, design, and functionality. Share
              timelines, milestones, and actionable strategies to move forward
              efficiently. By leveraging our experience and market knowledge, we
              create a tailored solution that sets your business up for success.
            </p>
          </div>
        ...
        <div className="row work">
          <div className="col-12 col-lg-6">
            ...
            <p className="mt-4">
              ...
              developers, designers, and project managers collaborate to
              kickstart the work. We keep you in the loop with regular updates,
              ensuring transparency throughout the process. We use Agile
              methodologies, breaking the project into smaller milestones, so we
              can test and refine the product iteratively. This phase ensures
              that you see progress at every step while allowing us to make
